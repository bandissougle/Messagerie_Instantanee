...
void printGuide(){
	...
	printf("\t\t*******************************\n");
	printf("\t\t***MESSAGERIE INSTANTANNEE***\n");
	printf("\t\t*******************************\n\n");


	printf("Choisir une fonctionnalité! \n\n");
	printf("1 => Afficher la liste des membres du groupe\n\n");
	printf("2 => Envoyer un message au groupe\n\n");
	printf("3 => Envoyer un message à un utilisateur (Syntaxe: 3:user_name:message)\n\n");
	printf("4 => Mettre à jour la liste des utilisateurs connectés\n\n");
